...
switch ($_GET["accion"])
{
	...
	case "generar_calendario":
	{
		...
		echo utf8_encode("<img src='images/img_escudo.png'><br><h2><b>INSTITUTO DE CULTURA DE SAMANÍEGO</b><br>Calendario de Eventos<br>".$meses[intval($fecha_calendario[1])]." de ".$fecha_calendario[0]." <abbr title='S&oacute;lo se pueden agregar eventos en d&iacute;as h&aacute;biles y en fechas futuras (o la fecha actual).'></abbr></h2>");
