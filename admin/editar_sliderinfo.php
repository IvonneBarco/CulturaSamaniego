					...
					<div class="collapse navbar-collapse" id="navegacion-cs">
						<ul class="nav navbar-nav">
							...
							<li><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"><span class="glyphicon glyphicon-user" id="icono"></span> Artesanos<span class="caret"></span></a> 
								<ul class="dropdown-menu" role="menu">
									<li><a href="registro_slidera.php" id="">Registrar Artesano</a></li>
									<li class="divider"></li>
...
<h2 class="post-title">
    <p class="titulop"><u>EDITAR INFORMACION INSTITUCIONAL</u></p><br>
</h2>
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE info SET titulo=%s, descripcion=%s, orden=%s, estado=%s WHERE codigo=%s",
  ...
  <div class="col-md-8">
	    ...
	    <div class="form-group">
		 ...
		 <div class="form-group">
			...
			<textarea  class="form-control" name="descripcion" value="<?php echo $row_edit_slider['descripcion']; ?>"  required></textarea>
		</div>
		<!--<div class="form-group">
