...
<head>
    ...
    <title id="titulo">.:: Listar Artesanos</title>
   ...
   <div class="row">
      <section class="posts col-md-12">       
        <div class="migas-de-pan"> <!--Inicia migas de pan-->       
          <ol class="breadcrumb" id="miga">
            ...
            <li class="active">Listar Artesanos</li>
          </ol>
    ...
    <div align= "right"><?php  echo "<b> BIENVENID@: <i class='verde';>" . $_SESSION["usuario"];"</i></b>" ?>
                <a href="cerrarSesion.php"><span class="glyphicon glyphicon-log-out btn-lg" title="Cerrar Sesión"></span></a></div>
                    ...
                    <h2 class="post-title">
                        <p class="titulop"><u>LISTADO DE ARTESANOS</u></p><br>
                    </h2>
...
<html lang="en">
  <head>
    ...
    <div class="container">
        ...
        <div class="col-md-12">
          <p><a class="btn btn btn-warning" href="registro_slider.php" role="button">Registrar Artesano</a></p>
        </div>
        <div class="col-md-12">
            ...
            <table class="table table-bordered table-hover" >
                <tbody>
                  ...
                  <?php do { ?>
                  <tr>
                    <td style="vertical-middle"><h3 class="font-csc-"><?php echo $row_ms_slider['descripcion']; ?></h3></td>
                    <td><img src="../recursos/uploads/<?php echo $row_ms_slider['imagen']; ?>" width="140" height="160"></td>
                   
                    <td><a class="btn btn btn-success btn-sm" href="editar_slidera.php?recordID=<?php echo $row_ms_slider['identificacion']; ?>" role="button">Editar</a>
                      <a class="btn btn btn-danger btn-sm" href="eliminar_slidera.php?recordID=<?php echo $row_ms_slider['identificacion']; ?>" role="button">Eliminar</a>                   </td>
                  </tr>
