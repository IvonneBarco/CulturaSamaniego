   ...
   <div class="row">
	...
	<div align= "right"><?php  echo "<b> BIENVENID@: <i class='verde';>" . $_SESSION["usuario"];"</i></b>" ?>
				<a href="cerrarSesion.php"><span class="glyphicon glyphicon-log-out btn-lg" title="Cerrar Sesión"></span></a></div>
                    ...
                    <h2 class="post-title">
                        <p class="titulop"><u>REGISTRAR INFORMACIÓN INSTITUCIONAL</u></p><br>
                    </h2>
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO info (titulo, descripcion,orden, estado) VALUES (%s,%s,%s,%s)",
...
<div class="row">
  ...
  <div class="col-md-8">
       ...
       onclick="javascript:subirimagen('imagen');"/>
		...
		<input type="submit" class="btn btn-warning" value="Insertar registro">
