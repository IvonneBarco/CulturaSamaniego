						...
						<div class="row">
							<div class="col-lg-12">	
					  		<?php
								...
								echo "<tr><th class='mith'>Código Modalidad</th><th class='mith'>Tipo de evento</th><th class='mith'>Modalidad</th></tr>\n";
								$mcod=100;
							...
							<form  action="regmodalidad2.php" method="POST" class="text-center">							
									...
									<div class="col-lg-12">
										...
										<table align="center" class="tabla-22">
										    <tr>
										        ...
										        <td><b><input type='text' class='form-control' name='codigomodalidad' id='codigomodalidad' value="<?php echo $mcod;?>" readonly placeholder='' aria-describedby='sizing-addon1'></b><br></td>
										    </tr>										    
										    <tr>
										    ...
										    <tr>
										       	...
										       	<td><input type='text' class='form-control' name='nombremodalidad' id='nombremodalidad' required placeholder='Nombre modalidad' aria-describedby='sizing-addon1'><br></td>
										    </tr>
										    <tr>
	                                            <td colspan="2">
