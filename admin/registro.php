        ...
        <div class="row"> <!-- Inicia contenedor-->         
            ...
            <section class="posts col-md-12">               
                ...
                <a href="cerrarSesion.php"><span class="glyphicon glyphicon-log-out btn-lg" title="Cerrar Sesión"></span></a></div>
                    <h2 class="post-title">
                        <p class="titulop"><u>FORMULARIO DE REGISTRO DE USUARIOS</u></p><br>
...
?>
        ...
        if(isset($_POST['enviar'])) { // comprobamos que se han enviado los datos desde el formulario
            ...
            if(!empty($sin_espacios[32])) { // comprobamos que el campo usuario_nombre no tenga espacios en blanco
                ...
                if(mysql_num_rows($sql)>0){
                    echo "<center><span class='letter-cs'>El nombre usuario elegido ya ha sido registrado anteriormente.</span></center><br>" ;
                    echo "<center><button type='button' class='btn btn-warning' value='Reintentar' id='regresar' onclick='javascript:history.back()'> Reintentar </button></center><br>";
                    ...
                    if($reg) {
                        echo "<center><span class='ok'>Datos ingresados correctamente.</span></center>" ;
                        echo "<center><a href ='registro.php' class='btn btn-success'>Regresar</a></center><br>";
                    }else {

                        echo "<center><span class='bad'>Ha ocurrido un error y no se registraron los datos...</span></center>";
    ...
    ?>
            ...
            <table id="mi_tabla">
                ...
                <tr>
                    <td align="center">
                        <input type="submit" class="btn btn-warning" name="enviar" value="Registrar"/>
