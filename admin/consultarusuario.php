        ...
        <div class="row"> <!-- Inicia contenedor-->         
            ...
            <section class="posts col-md-12">               
                ...
                <a href="cerrarSesion.php"><span class="glyphicon glyphicon-log-out btn-lg" title="Cerrar Sesión"></span></a></div>
                    <h2 class="post-title">
                        <p class="titulop"><u>CONSULTAR USUARIOS</u></p><br>
                    ...
                    <?php
                        ...
                        <tr>
                            <th colspan="2"><center><input type="button" name="btn1" value="Regresar" class='btn btn-warning' onclick="location= 'administracion.php'" readonly aria-describedby='sizing-addon1'/></center><br></th>
                        </tr>    
                        </table>
                        </form>
