                        ...
                        <?php
                            ...
                            if(isset($_POST["btn1"])){
                                ...
                                if($btn=="Buscar"){
                                    ...
                                    if($codeve!='' and $mod!='' and $estado!='' and $version!='' and $fecha!='' and $valor!='' and $descripcion!=''){
                                    $sql="update evento set codevento='$codeve' codmodalidad='$mod' estado='$estado' version='$version' fecha='$fecha' valor='$valor' descripcion='$descripcion' where codevento='$codeve'";
