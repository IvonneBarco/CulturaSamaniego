      ...
      <section class="posts col-md-12">       
        ...
        <div align= "right"><?php  echo "<b> BIENVENID@: <i class='verde';>" . $_SESSION["usuario"];"</i></b>" ?>
                <a href="cerrarSesion.php"><span class="glyphicon glyphicon-log-out btn-lg" title="Cerrar Sesión"></span></a></div>
                    ...
                    <h2 class="post-title">
                        <p class="titulop"><u>LISTADO INFORMACIÓN INSTITUCIONAL</u></p><br>
                    </h2>
        ...
        <div class="col-md-12">
            ...
            <table class="table table-bordered table-hover style='color: #000000' ">
                <tbody>
                  ...
                  <?php do { ?>
                  <tr>
                    <td style="vertical-middle"><h3 class="font-csc-"><?php echo utf8_encode( $row_ms_slider ['titulo']); ?></h3></td>
                    <td style="vertical-middle"><h3 class="font-csc-"><?php echo $row_ms_slider['descripcion']; ?></h3></td>
                   <!-- <td><img src="../recursos/info/<?php echo $row_ms_slider['imagen']; ?>" width="230" height="180"></td>-->
